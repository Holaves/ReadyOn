...
const burgerBtnClose = document.querySelector('#burger-button-menu')
...
const span4 = document.querySelector('#span10')
const span5 = document.querySelector('#span20')
const span6 = document.querySelector('#span30')

burgerBtn.addEventListener('click', () => {
  burgerBtnAnimation(burgerWindowOpen)
})
burgerBtnClose.addEventListener('click', () => {
  burgerBtnCloseAnimation(burgerWindowClose)
})


function burgerBtnAnimation(callback) {
  burgerBtn.setAttribute('class', 'burger-button_animation')
  spans.forEach(currentValue => {
    currentValue.setAttribute('class', 'burger-span_animation')
  })
  span1.classList.add('opacity-0')
  span2.classList.add('rotate-1')
  span3.classList.add('rotate-2')
  setTimeout(callback, 1000)
  
}
function burgerWindowOpen() {
  const BurgerWindow = document.querySelector('.burger-window')
  BurgerWindow.style.display = 'block'

  body.style.overflow = 'hidden'
}
function burgerBtnCloseAnimation(callback) {
  burgerBtnClose.setAttribute('class', 'burger-button-menu_animation')
  span4.setAttribute('class', 'burger-span-menu')
  span5.setAttribute('class', 'burger-span-menu')
  span6.setAttribute('class', 'burger-span-menu')
  
  span4.classList.add('opacity-0-none')
  span5.classList.add('rotate-1-none')
  span6.classList.add('rotate-2-none')
  setTimeout(callback, 1000)
}
function burgerWindowClose() {
  body.style.overflow = 'visible'
  body.style.overflowX = 'hidden'

  burgerBtn.setAttribute('class', 'burger-button')
  span1.setAttribute('class', 'burger-span')
  span2.setAttribute('class', 'burger-span')
  span3.setAttribute('class', 'burger-span')
  document.querySelector('.burger-window').style.display = 'none'

  burgerBtnClose.setAttribute('class', 'burger-button-menu')
  span4.setAttribute('class', 'opacity-0')
  span5.setAttribute('class', 'rotate-1')
  span6.setAttribute('class', 'rotate-2')
}
